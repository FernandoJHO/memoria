                        ...
                        <div class="col-sm-12">
                        	...
                        	<div class="form-box">
	                            ...
	                            <div class="form-bottom">
				                    ...
				                    <form action="<?php echo base_url();?>recuperarClave/cambiar_clave_alumno" method="post" class="login-form">
                                        <div class="form-group">
                                            <label class="sr-only">Nueva contraseña</label>
                                            <input type="password" name="nueva" placeholder="Nueva contraseña" required="true" class="form-username form-control">
                                        </div>
                                        <div class="form-group">
                                            <label class="sr-only">Repetir contraseña</label>
                                            <input type="password" name="nueva_verif" placeholder="Repetir contraseña" required="true" class="form-username form-control">
                                        </div>
