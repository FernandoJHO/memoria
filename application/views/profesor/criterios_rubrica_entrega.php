...
<html lang="en">
    <head>
        ...
        <title>Criterios categoría <?php echo $nombre_categoria; ?></title>
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="card-action">
                                                        ...
                                                        <a href="<?php echo base_url();?>evaluacion/items/<?php echo $criterio['id']; ?>/<?php echo str_replace(' ', '_', $criterio['nombre']); ?>/<?php echo str_replace(' ', '_', $nombre_categoria); ?>/<?php echo $numero_entrega; ?>/<?php echo $id_grupo; ?>/<?php echo $numero_grupo; ?>/<?php echo $id_rubrica; ?>" class="btn btn-default" style="width:100%;" target="_blank"><i class="la la-pencil"></i> Evaluar items</a>
